...
## Version [15.0.0](https://git.belin.io/cedx/akismet.js/compare/v14.0.0...v15.0.0)
- Breaking change: raised the required [Node.js](https://nodejs.org) version.
- Dropped support for [GitHub Packages](https://github.com/features/packages).
- Updated the documentation.
- Updated the package dependencies.

## Version [14.0.0](https://git.belin.io/cedx/akismet.js/compare/v13.0.1...v14.0.0)
...
## Version [13.0.1](https://git.belin.io/cedx/akismet.js/compare/v12.0.0...v13.0.1)
- Breaking change: changed the signature of the `Client` events.
- Updated the package dependencies.

## Version [12.0.0](https://git.belin.io/cedx/akismet.js/compare/v11.0.0...v12.0.0)
...
## Version [11.0.0](https://git.belin.io/cedx/akismet.js/compare/v10.1.0...v11.0.0)
...
## Version [10.1.0](https://git.belin.io/cedx/akismet.js/compare/v10.0.0...v10.1.0)
- Replaced the [SuperAgent](https://visionmedia.github.io/superagent) HTTP client by `node-fetch`.
- Updated the package dependencies.

## Version [10.0.0](https://git.belin.io/cedx/akismet.js/compare/v9.1.0...v10.0.0)
...
## Version [9.1.0](https://git.belin.io/cedx/akismet.js/compare/v9.0.0...v9.1.0)
- Removed the dependency on [Babel](https://babeljs.io) compiler.
- Updated the package dependencies.

## Version [9.0.0](https://git.belin.io/cedx/akismet.js/compare/v8.0.1...v9.0.0)
- Breaking change: reverted the API of the `Client` class to an [Observable](http://reactivex.io/intro.html)-based one.
- Added new unit tests.
- Updated the package dependencies.

## Version [8.0.1](https://git.belin.io/cedx/akismet.js/compare/v8.0.0...v8.0.1)
- Fixed a code generation bug.
- Updated the package dependencies.

## Version [8.0.0](https://git.belin.io/cedx/akismet.js/compare/v7.1.0...v8.0.0)
...
## Version [7.1.0](https://git.belin.io/cedx/akismet.js/compare/v7.0.0...v7.1.0)
- Added support for the [Node Security Platform](https://nodesecurity.io) reports.
- Updated the package dependencies.

## Version [7.0.0](https://git.belin.io/cedx/akismet.js/compare/v6.2.0...v7.0.0)
...
## Version [6.2.0](https://git.belin.io/cedx/akismet.js/compare/v6.1.0...v6.2.0)
- Updated the package dependencies.

## Version [6.1.0](https://git.belin.io/cedx/akismet.js/compare/v6.0.0...v6.1.0)
- Removed the dependency on the `@cedx/enum` module.
- Removed the dependency on the `gulp-load-plugins` module.

## Version [6.0.0](https://git.belin.io/cedx/akismet.js/compare/v5.0.0...v6.0.0)
- Breaking change: raised the required [Node.js](https://nodejs.org) version.
...
## Version [5.0.0](https://git.belin.io/cedx/akismet.js/compare/v4.0.0...v5.0.0)
...
## Version [4.0.0](https://git.belin.io/cedx/akismet.js/compare/v3.4.0...v4.0.0)
...
## Version [3.4.0](https://git.belin.io/cedx/akismet.js/compare/v3.3.0...v3.4.0)
- Replaced the [Codacy](https://www.codacy.com) code coverage service by the [Coveralls](https://coveralls.io) one.
- Updated the package dependencies.

## Version [3.3.0](https://git.belin.io/cedx/akismet.js/compare/v3.2.0...v3.3.0)
- Added the `onRequest` and `onResponse` event streams to the `Client` class.

## Version [3.2.0](https://git.belin.io/cedx/akismet.js/compare/v3.1.0...v3.2.0)
- Updated the [SuperAgent](https://visionmedia.github.io/superagent) dependency.

## Version [3.1.0](https://git.belin.io/cedx/akismet.js/compare/v3.0.0...v3.1.0)
- Allowing to set dates as timestamps or strings in the `Comment` constructor.

## Version [3.0.0](https://git.belin.io/cedx/akismet.js/compare/v2.0.1...v3.0.0)
...
## Version [2.0.1](https://git.belin.io/cedx/akismet.js/compare/v2.0.0...v2.0.1)
- Added a dedicated enumeration API to the `CommentType` type.

## Version [2.0.0](https://git.belin.io/cedx/akismet.js/compare/v1.0.1...v2.0.0)
...
## Version [1.0.1](https://git.belin.io/cedx/akismet.js/compare/v1.0.0...v1.0.1)
- Fixed the [issue #5](https://git.belin.io/cedx/akismet.js/issues/5).

## Version [1.0.0](https://git.belin.io/cedx/akismet.js/compare/v0.9.0...v1.0.0)
- Breaking change: changed the signature of the `fromJSON()` methods.
...
## Version [0.9.0](https://git.belin.io/cedx/akismet.js/compare/v0.8.0...v0.9.0)
...
## Version [0.8.0](https://git.belin.io/cedx/akismet.js/compare/v0.7.1...v0.8.0)
...
## Version [0.7.1](https://git.belin.io/cedx/akismet.js/compare/v0.7.0...v0.7.1)
- Added a command line option to set the user to drop privileges to once server socket is bound.
- Fixed the [issue #4](https://git.belin.io/cedx/akismet.js/issues/4): properly handle the `host` and `port` command line arguments.
- Upgraded the package dependencies.

## Version [0.7.0](https://git.belin.io/cedx/akismet.js/compare/v0.6.2...v0.7.0)
...
## Version [0.6.2](https://git.belin.io/cedx/akismet.js/compare/v0.6.1...v0.6.2)
- Fixed a bug in `Comment.toJSON()` method.

## Version [0.6.1](https://git.belin.io/cedx/akismet.js/compare/v0.6.0...v0.6.1)
- Fixed the usage of `Author.role` property.
- Fixed the usage of `Client.isTest` property.
- Fixed a unit test.

## Version [0.6.0](https://git.belin.io/cedx/akismet.js/compare/v0.5.1...v0.6.0)
...
## Version [0.5.2](https://git.belin.io/cedx/akismet.js/compare/v0.5.1...v0.5.2)
- Upgraded the package dependencies.

## Version [0.5.1](https://git.belin.io/cedx/akismet.js/compare/v0.5.0...v0.5.1)
- Upgraded the package dependencies.

## Version [0.5.0](https://git.belin.io/cedx/akismet.js/compare/v0.4.1...v0.5.0)
...
- Upgraded the package dependencies.
- Fixed the [issue #3](https://git.belin.io/cedx/akismet.js/issues/3): returning a `Promise` in `Server.checkComment()` method.

## Version [0.4.1](https://git.belin.io/cedx/akismet.js/compare/v0.4.0...v0.4.1)
- Fixed the [issue #2](https://git.belin.io/cedx/akismet.js/issues/2): using a Unix system for publishing the package on [npm](https://www.npmjs.com).

## Version [0.4.0](https://git.belin.io/cedx/akismet.js/compare/v0.3.5...v0.4.0)
...
## Version [0.3.5](https://git.belin.io/cedx/akismet.js/compare/v0.3.4...v0.3.5)
- Using [Gulp](https://gulpjs.com) as build system.

## Version [0.3.4](https://git.belin.io/cedx/akismet.js/compare/v0.3.3...v0.3.4)
- CORS headers handling delegated to [`cors`](https://www.npmjs.com/package/cors) module.

## Version [0.3.3](https://git.belin.io/cedx/akismet.js/compare/v0.3.2...v0.3.3)
- Upgraded the package dependencies.

## Version [0.3.2](https://git.belin.io/cedx/akismet.js/compare/v0.3.1...v0.3.2)
- Lowered the required [Node.js](http://nodejs.org) version.

## Version [0.3.1](https://git.belin.io/cedx/akismet.js/compare/v0.3.0...v0.3.1)
- Fixed bugs in server implementation: bad error handling.

## Version [0.3.0](https://git.belin.io/cedx/akismet.js/compare/v0.2.1...v0.3.0)
- Added `Blog` class to support the latest [Akismet](https://akismet.com) APIs.

## Version [0.2.1](https://git.belin.io/cedx/akismet.js/compare/v0.2.0...v0.2.1)
- Fixed bugs in server implementation: bad parsing of client requests.

## Version [0.2.0](https://git.belin.io/cedx/akismet.js/compare/v0.1.0...v0.2.0)
