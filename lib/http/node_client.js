...
import {BaseClientConstructor, BaseClientPrototype} from './base_client.js';
...
// Apply the `BaseClient` mixin.
Object.assign(NodeClient, BaseClientConstructor);
Object.assign(NodeClient.prototype, BaseClientPrototype);
