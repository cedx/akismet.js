...
module.exports = class Blog {
  ...
  /**
   * Creates a new blog from the specified JSON string.
   * @param {string} json A JSON string representing a blog.
   * @returns {Blog} The instance corresponding to the specified JSON data, or `null` if a parsing error occurred.
   */
