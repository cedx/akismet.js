...
module.exports = class Comment {
   ...
   * @param {string} json A JSON string representing a comment.
   * @returns {Comment} The instance corresponding to the specified JSON data, or `null` if a parsing error occurred.
   */
