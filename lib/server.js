...
function Server(options) {
  ...
  this._express.set('debug', 'NODE_ENV' in process.env && process.env.NODE_ENV!='production');
...
Server._processRequest=function(req, res, next) {
  ...
  req.akismet={
    client: new Client(apiKey, blog, { userAgent: userAgent, useSecureRequests: true }),
...
Server.prototype._registerRoutes=function() {
  ...
  this._express.post(enums.EndPoints.SUBMIT_HAM, this.submitSpam.bind(this));
