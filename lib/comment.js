 ...
 * @method fromJSON
 * @param {String} json A JSON string representing an `Comment`.
 * @return {Comment} The instance corresponding to the specified JSON string, or `null` if a parsing error occurred.
 * @static
 */
Comment.fromJSON=function(json) {
  try {
    ...
    return new Comment({
      author: Author.fromJSON(JSON.stringify(map['author'])),
