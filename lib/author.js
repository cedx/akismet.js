...
function Author(properties) {
  ...
  if(typeof properties=='object') for(var key in properties) {
 ...
 * @method fromJSON
 * @param {String} json A JSON string representing an `Author`.
 * @return {Author} The instance corresponding to the specified JSON string, or `null` if a parsing error occurred.
 * @static
 */
